import { loadInteractiveCards } from '/scripts/loadInteractiveCards.js'
...
document.addEventListener("DOMContentLoaded",
	...
	(() => {//crea una lambda senza nome
		let funct = (event) => {//crea una seconda lambda con nome da usare come callback
			loadInteractiveCards('../src/json/home_interactive_cards.json'); // chiama la funzione importata
